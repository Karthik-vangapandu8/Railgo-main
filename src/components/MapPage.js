    ...
    <div className="relative h-screen w-full bg-gray-400">
        ...
        <div className="flex gap-2">
          {facilitiesData.map((facility) => (
            <button
              ...
              className="flex items-center justify-center bg-white rounded-full shadow-md px-1 py-1"
            >
              <FontAwesomeIcon 
      ...
      <div className="fixed flex flex-col gap-2 right-8 bottom-10 z-50">
        <div className="flex flex-col bg-white rounded-full shadow-md">
          <button className="h-10 w-10 rounded-t-full bg-white hover:bg-gray-100 cursor-pointer">
            <FontAwesomeIcon icon={faPlus} className="h-[45%] w-[45%] align-middle" />
          </button>
          <button className="h-10 w-10 rounded-b-full bg-white hover:bg-gray-100 cursor-pointer">
            <FontAwesomeIcon icon={faMinus} className="h-[45%] w-[45%] align-middle" />
          </button>
        </div>
        <button className="h-10 w-10 rounded-full shadow-md bg-white cursor-pointer">
